  ...
  return (
    ...
    <div className="navBar h-20 relative">
      ...
      <div className="searchBar relative">
        <input type="text" name='searchValue' className='searchInput top-[4px] absolute' placeholder='Search' />
      ...
      <div className="w-[54px] h-[54px] left-[433px] top-[13px] absolute">
        <div className="profileImg w-[50.82px] h-[50.82px] left-[1.59px] top-[1.59px] absolute"/>
        <div className="w-[54px] h-[54px] left-0 top-0 absolute rounded-full" />
      </div>

      

      <a href="#" className='navFriends  font  absolute  font-medium'>My Friends</a>
      <a href="#" className='navGallery  font  absolute  font-medium'>My Gallery</a>
    </div>
    </>
  )
}
